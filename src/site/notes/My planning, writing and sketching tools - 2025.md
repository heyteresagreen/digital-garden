...
tags:
  - systems
  - tools
slug: my-planning-writing-and-sketching-tools-2025
---
...
* A plain notebook for **personal projects, diagrams, [[Sketchnotes|sketchnotes]], to-dos and thoughts**. Currently using a plain Moleskine cahier notebook.
* A homemade notebook for **[[Morning Pages|Morning Pages]]**, using old dot grid Leuchturm notebook paper. 
* A **[[Sketchbooks|sketchbook]]** with smooth mixed media paper nice for **sketching and painting**. Currently using a homemade sketchbook.
* A light blue coloured Kaweco Sport **[[Fountain pens|fountain pen]]** with sepia ink for writing and drawing (I also use various other art materials but this is the one always with the notebook)
...
* **Fleeting notes, reading notes, and evergreen notes**. This is my zettlekasten, my personal digital garden of notes from things I've read, heard or thought about. Each evergreen note contains one idea and usually a bunch of references, (ideally) linked densely with other notes. The fleeting notes are mostly highlights from [[Reading things later|articles I've saved to Instapaper]].
* **Website writing.** I publish some of my notes online, including [[Art|Art]], [[Writing|Writing]], [[Letters|Letters]], and a smattering of my evergreen notes.  Here's [[My Obsidian workflow|My Obsidian workflow]] for notes that I publish to [teresawatts.com](http://teresawatts.com)
### Previously
